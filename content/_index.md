...
<section class='hero'>
 <img src='./images/menu.png' alt='menu-icon' class='menuIcon position-absolute' style='width:1.5rem;right:10px; top:10px;'/>
 <div class='menu d-flex flex-column active px-3 py-5'>
 <img src='./images/close.png' alt='menu-icon' class='closeIcon position-absolute' style='width:1.5rem;right:10px; top:10px;'/>
 <a href='#Loutka' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Loutka uhlobaronůs</a>
 <a href='#dzban' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Koupaliště Džbán</a>
 <a href='#Obchodní' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Obchodní centrum Stromovka</a>
 <a href='#Stěhování' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Stěhování TSK do Stromovky</a>
 <a href='#Koupě' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Koupě budovy radnice a poskytnutá provize</a>
 <a href='#Stanice' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Stanice metra Nádraží Holešovice</a>
 <a href='#domu' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Koupě domu na horách za 250 000 korun</a>
 <a href='#bytu' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Privatizace bytu matky Jendy Čižinského</a>
 <a href='#most' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Libeňský most</a>
 <a href='#Zvolení' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Zvolení obviněného Mateje Augustina</a>
 <a href='#adama' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Služební vůz Adama Scheinherra</a>
 <a href='#Velikost' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Velikost bytu pana starosty</a>
 <a href='#Rušení' class='text-decoration-none fs-5 fw-bold text-dark mb-1'>Rušení tenisových kurtů na Štvanici</a>
 </div>
...
<div class='container-fluid intro_div py-3'>
...
<!-- ############ Loutka uhlobaronů Section Start############ -->
...
<!-- ############## Stěhování TSK do Stromovky Sec Start ############ -->
...
<!-- ############## Stěhování TSK do Stromovky Sec End ############ -->





<!-- ############ Koupě budovy radnice a poskytnutá provize Section Start############ -->
...
<!-- ############   Koupě budovy radnice a poskytnutá provize Section End############ -->
      ...
      <div class='bg-white d-flex  gap-2 mb-3 p-2'>
       ...
       <div class='ms-3'>
        ...
        <a href='./images/Klokneruv_ustav_2129963_634982_Expertni_zprava_CVUT.pdf' style='font-size:12px;' class='d-flex align-items-center gap-1'>
                 ...
                 <span>posudek kloknerova ustavu ze ktere vyplyva, ze rekonstrukce mostu neni mozna</span>
                 </a>
       </div>
  </div>
</div>
...
<!-- ############## Koupaliště Džbán Sec Start ############ -->
<section class='dzban ' style='background:#9ddee4;' id='adama'>
<div class='container-fluid dzban_div py-3'>
<div class='row justify-content-center'>
<div class='col-md-7 col-12 d-flex justify-content-center flex-md-nowrap flex-wrap p-md-0 p-2 gap-2'>
